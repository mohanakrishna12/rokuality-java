...
| App | The friendly id of your app for Roku and XBox. For Roku, if you provide this cap and ommit the 'AppPackage' cap then the device will attempt to launch an already sideloaded .zip. For XBox this MUST be the app id of your installed .appxbundle - if you ommit the 'AppPackage' cap then the device will attempt to launch an already installed app matching this id. |Roku = Optional. XBox = Required. HDMI = Ignored | String |
